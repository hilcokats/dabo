...
public interface You extends AnyPlayer {
    ...
    default boolean draw(DefinedCard card) {
        return draw(card.getName());
    }

    default boolean play(DefinedCard card) {
        return play(card.getName());
    }

    default boolean discard(DefinedCard card) {
        return discard(card.getName());
    }

    default boolean removeFromGame(DefinedCard card) {
        return removeFromGame(card.getName());
    }

    default boolean command(DefinedCard card) {
        return command(card.getName());
    }

    default boolean own(DefinedCard card) {
